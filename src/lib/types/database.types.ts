  ...
  public: {
    Tables: {
      ...
      trucks: {
        ...
        Insert: Omit<Database["public"]["Tables"]["trucks"]["Row"], "id" | "created_at"> & { id?: string };
      ...
      drivers: {
        ...
        Insert: Omit<Database["public"]["Tables"]["drivers"]["Row"], "id" | "created_at"> & { id?: string };
      ...
      facilities: {
        ...
        Insert: Omit<Database["public"]["Tables"]["facilities"]["Row"], "id" | "created_at"> & { id?: string };
      ...
      brokers: {
        ...
        Insert: Omit<Database["public"]["Tables"]["brokers"]["Row"], "id" | "created_at" | "loads_booked_count" | "total_revenue"> & { id?: string };
      ...
      loads: {
        ...
        Insert: Omit<Database["public"]["Tables"]["loads"]["Row"], "id" | "created_at" | "updated_at"> & { id?: string };
      ...
      detention_events: {
        ...
        Insert: Omit<Database["public"]["Tables"]["detention_events"]["Row"], "id" | "created_at" | "billable_minutes"> & { id?: string };
      ...
      revenue_recovery_items: {
        ...
        Insert: Omit<Database["public"]["Tables"]["revenue_recovery_items"]["Row"], "id" | "created_at" | "variance"> & { id?: string };
      ...
      email_parse_log: {
        ...
        Insert: Omit<Database["public"]["Tables"]["email_parse_log"]["Row"], "id" | "created_at"> & { id?: string };
